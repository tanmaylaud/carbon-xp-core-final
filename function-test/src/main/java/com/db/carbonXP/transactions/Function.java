    ...
    public class Function {
        ...
        public HttpResponseMessage run(
            ...
            if (name == null) {
                ...
                return request.createResponseBuilder(HttpStatus.OK).body("Hello, " + name + "! The currentRate is = "+ RateCalculator.getCurrentRate()).build();
            }
        }
        @FunctionName("sell-xp")
